-- ============================================================================
-- CRIAR POLÍTICAS RLS NOVAS (SEM RECURSÃO)
-- ============================================================================
-- Descrição: Cria políticas RLS usando funções helper que não causam recursão
-- ============================================================================
...
CREATE POLICY "companies_delete_own" ON companies
  FOR DELETE
  USING (id = auth.get_user_company_id() AND auth.is_admin());
...
CREATE POLICY "profiles_delete_own" ON profiles
  FOR DELETE
  USING (
    company_id = auth.get_user_company_id() AND auth.is_admin()
  );
